                ...
                <div className="wrapper-page">
                    ...
                    <Card className="overflow-hidden account-card mx-3">
                        ...
                        <div className="bg-primary p-4 text-white text-center position-relative">
                            ...
                            <p className="text-white-50 mb-4">Get your free Qms account now.</p>
                            <Link to="/" className="logo logo-admin"><img src={logosm} height="78" alt="logo" /></Link>
                        </div>
                            ...
                            <AvForm className="form-horizontal m-t-30" onValidSubmit={this.handleSubmit} >
                                ...
                                <Row className="form-group m-t-10 mb-0">
                                    <Col md="12" className="m-t-20">
                                        <p className="mb-0">By registering you agree to the Qms <Link to="#" className="text-primary">Terms of Use</Link></p>
                                    </Col>
                                </Row>
