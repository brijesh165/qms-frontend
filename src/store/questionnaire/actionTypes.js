const questionnaire = {
    ...
    DELETE_QUESTIONNAIRE_SUCCESSFUL: 'delete_questionnaire_successful',
    COPY_QUESTIONNAIRE_START: 'copy_questionnaire_start',
    COPY_QUESTIONNAIRE_SUCCESSFUL: 'copy_questionnaire_successful',
